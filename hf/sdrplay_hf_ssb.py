...
# Title: Sdrplay Hf Ssb
# Generated: Sat Jan 19 01:39:32 2019
...
class sdrplay_hf_ssb(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sdrplay Hf Ssb")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sdrplay Hf Ssb")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sdrplay_hf_ssb")
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.sdrplay_rspduo_source_0 = sdrplay.rspduo_source(rx_freq, 200, True, 40, True, True,
                False, 0, 1, samp_rate, True, True, 0, False,
                '0', 'T1_50ohm')
        ...
        self.connect((self.sdrplay_rspduo_source_0, 0), (self.blocks_multiply_xx_0, 0))
...
def main(top_block_cls=sdrplay_hf_ssb, options=None):
