...
# Title: Fsk Tx Uhd
# Generated: Tue Mar 27 15:34:55 2018
##################################################
...
class fsk_tx_uhd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, fsk_dev=10000, lpf_cutoff=12.5e3, lpf_trans=1e3, tx_freq=401.5e6, tx_offset=250e3):
        gr.top_block.__init__(self, "Fsk Tx Uhd")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fsk Tx Uhd")
...
def main(top_block_cls=fsk_tx_uhd, options=None):
    ...
    tb = top_block_cls(fsk_dev=options.fsk_dev, lpf_cutoff=options.lpf_cutoff, lpf_trans=options.lpf_trans, tx_freq=options.tx_freq, tx_offset=options.tx_offset)
    tb.start()
    tb.show()
