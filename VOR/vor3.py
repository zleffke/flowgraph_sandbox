...
class vor3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "vor3")
        ...
        for c in range(4, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.sigmf_source_0 = gr_sigmf.source('/captures/20191216/VOR_2019-12-16T18:51:17Z.sigmf-data', "cf32" + ("_le" if sys.byteorder == "little" else "_be"), True)
        ...
        self.connect((self.analog_agc2_xx_0_0, 0), (self.blocks_stream_to_vector_1, 0))
        self.connect((self.analog_agc2_xx_0_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.analog_agc2_xx_0_0_0, 0), (self.blocks_stream_to_vector_0, 0))
        ...
        self.connect((self.blocks_complex_to_arg_0, 0), (self.hilbert_fc_0_0, 0))
        self.connect((self.blocks_complex_to_arg_0_0, 0), (self.hilbert_fc_0, 0))
        ...
        self.connect((self.hilbert_fc_0_0, 0), (self.qtgui_freq_sink_x_0, 1))
...
def main(top_block_cls=vor3, options=None):
