...
class nexrad_playback_sigmf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.throttle_rate = throttle_rate = 10
        ...
        self._look_ahead_line_edit.returnPressed.connect(
        	lambda: self.set_look_ahead(int(str(self._look_ahead_line_edit.text().toAscii()))))
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, tune, 1, 0)
