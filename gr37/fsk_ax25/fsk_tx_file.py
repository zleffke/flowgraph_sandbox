...
# Title: Simple GMSK/AX.25 Transmitter
# Author: Zach Leffke, KJ4QLP
# Description: Simple transmitter, spectrum sink (no uhd)
#
# Generated: Sun Aug 26 15:36:42 2018
...
class fsk_tx_file(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range(0, self.samp_rate/self.decim * self.interp/5)
...
def main(top_block_cls=fsk_tx_file, options=None):
    if options is None:
