...
# Title: Sdrplay Hf Weaver
# Generated: Fri Jan 18 20:19:16 2019
...
class sdrplay_hf_weaver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.sdrplay_rspduo_source_0 = sdrplay.rspduo_source(rx_freq, 200, bool(agc), if_attn, True, True,
...
def main(top_block_cls=sdrplay_hf_weaver, options=None):
