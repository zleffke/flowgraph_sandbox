...
# Title: Playback for Complex Int 16 Datatype
...
class playback_ci16(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Playback for Complex Int 16 Datatype")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Playback for Complex Int 16 Datatype")
        ...
        self.settings = Qt.QSettings("GNU Radio", "playback_ci16")
        ...
        self._throttle_factor_tool_bar.addWidget(Qt.QLabel('Throttle Factor'+": "))
        ...
        self.top_grid_layout.addWidget(self._throttle_factor_tool_bar, 8, 2, 1, 2)
        for r in range(8, 9):
        ...
        self.top_grid_layout.addWidget(self._samp_rate_tool_bar, 8, 0, 1, 2)
        for r in range(8, 9):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_short*2, samp_rate * throttle_factor,True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*2, '/tmp/HF_12.5MSPS_2020-08-13T05:01:51.370400Z.ci16', True)
...
def main(top_block_cls=playback_ci16, options=None):
