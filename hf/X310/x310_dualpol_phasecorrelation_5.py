...
# Title: Dual Polarization Phase Correlation, Start Time [UTC]: 2020-09-13T23:15:32.461128Z
...
class x310_dualpol_phasecorrelation_5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Dual Polarization Phase Correlation, Start Time [UTC]: 2020-09-13T23:15:32.461128Z")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dual Polarization Phase Correlation, Start Time [UTC]: 2020-09-13T23:15:32.461128Z")
        ...
        self.settings = Qt.QSettings("GNU Radio", "x310_dualpol_phasecorrelation_5")
        ...
        self.pll_lbw_0 = pll_lbw_0 = 200
        self.pll_lbw = pll_lbw = 200
        self.pll_freq_0 = pll_freq_0 = 100
        self.pll_freq = pll_freq = 100
        self.phase_rad = phase_rad = phase_shift * math.pi/180.0
        self.lpf_trans_0 = lpf_trans_0 = 10
        self.lpf_trans = lpf_trans = 10
        self.lpf_cutoff_0 = lpf_cutoff_0 = 10
        self.lpf_cutoff = lpf_cutoff = 10
        ...
        self.main_tab.addTab(self.main_tab_widget_5, 'Cpol')
        ...
        for c in range(1, 2):
            self.main_tab_grid_layout_0.setColumnStretch(c, 1)
        self._pll_lbw_0_tool_bar = Qt.QToolBar(self)
        self._pll_lbw_0_tool_bar.addWidget(Qt.QLabel("pll_lbw_0"+": "))
        self._pll_lbw_0_line_edit = Qt.QLineEdit(str(self.pll_lbw_0))
        self._pll_lbw_0_tool_bar.addWidget(self._pll_lbw_0_line_edit)
        self._pll_lbw_0_line_edit.returnPressed.connect(
        	lambda: self.set_pll_lbw_0(eng_notation.str_to_num(str(self._pll_lbw_0_line_edit.text().toAscii()))))
        self.main_tab_grid_layout_5.addWidget(self._pll_lbw_0_tool_bar, 7, 1, 1, 1)
        for r in range(7, 8):
        ...
        self._pll_freq_0_tool_bar = Qt.QToolBar(self)
        self._pll_freq_0_tool_bar.addWidget(Qt.QLabel("pll_freq_0"+": "))
        self._pll_freq_0_line_edit = Qt.QLineEdit(str(self.pll_freq_0))
        self._pll_freq_0_tool_bar.addWidget(self._pll_freq_0_line_edit)
        self._pll_freq_0_line_edit.returnPressed.connect(
        	lambda: self.set_pll_freq_0(eng_notation.str_to_num(str(self._pll_freq_0_line_edit.text().toAscii()))))
        self.main_tab_grid_layout_5.addWidget(self._pll_freq_0_tool_bar, 7, 0, 1, 1)
        for r in range(7, 8):
            self.main_tab_grid_layout_5.setRowStretch(r, 1)
        for c in range(0, 1):
            self.main_tab_grid_layout_5.setColumnStretch(c, 1)
        ...
        for c in range(0, 1):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        self._lpf_trans_0_tool_bar = Qt.QToolBar(self)
        self._lpf_trans_0_tool_bar.addWidget(Qt.QLabel('LPF Transition'+": "))
        self._lpf_trans_0_line_edit = Qt.QLineEdit(str(self.lpf_trans_0))
        self._lpf_trans_0_tool_bar.addWidget(self._lpf_trans_0_line_edit)
        self._lpf_trans_0_line_edit.returnPressed.connect(
        	lambda: self.set_lpf_trans_0(eng_notation.str_to_num(str(self._lpf_trans_0_line_edit.text().toAscii()))))
        self.main_tab_grid_layout_5.addWidget(self._lpf_trans_0_tool_bar, 8, 3, 1, 1)
        for r in range(8, 9):
            self.main_tab_grid_layout_5.setRowStretch(r, 1)
        for c in range(3, 4):
            self.main_tab_grid_layout_5.setColumnStretch(c, 1)
        ...
        for c in range(3, 4):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        self._lpf_cutoff_0_tool_bar = Qt.QToolBar(self)
        self._lpf_cutoff_0_tool_bar.addWidget(Qt.QLabel('LPF Cutoff'+": "))
        self._lpf_cutoff_0_line_edit = Qt.QLineEdit(str(self.lpf_cutoff_0))
        self._lpf_cutoff_0_tool_bar.addWidget(self._lpf_cutoff_0_line_edit)
        self._lpf_cutoff_0_line_edit.returnPressed.connect(
        	lambda: self.set_lpf_cutoff_0(eng_notation.str_to_num(str(self._lpf_cutoff_0_line_edit.text().toAscii()))))
        self.main_tab_grid_layout_5.addWidget(self._lpf_cutoff_0_tool_bar, 8, 2, 1, 1)
        for r in range(8, 9):
            self.main_tab_grid_layout_5.setRowStretch(r, 1)
        for c in range(2, 3):
            self.main_tab_grid_layout_5.setColumnStretch(c, 1)
        ...
        self.qtgui_histogram_sink_x_0_1_1_0 = qtgui.histogram_sink_f(
        	200,
        	360,
                -360,
                360,
        ...
        self.qtgui_histogram_sink_x_0_1_1_0.set_update_time(0.010)
        self.qtgui_histogram_sink_x_0_1_1_0.enable_autoscale(True)
        self.qtgui_histogram_sink_x_0_1_1_0.enable_accumulate(True)
        self.qtgui_histogram_sink_x_0_1_1_0.enable_grid(False)
        self.qtgui_histogram_sink_x_0_1_1_0.enable_axis_labels(True)

        if not True:
          self.qtgui_histogram_sink_x_0_1_1_0.disable_legend()
        ...
        for i in xrange(1):
            if len(labels[i]) == 0:
                self.qtgui_histogram_sink_x_0_1_1_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_histogram_sink_x_0_1_1_0.set_line_label(i, labels[i])
            self.qtgui_histogram_sink_x_0_1_1_0.set_line_width(i, widths[i])
            self.qtgui_histogram_sink_x_0_1_1_0.set_line_color(i, colors[i])
            self.qtgui_histogram_sink_x_0_1_1_0.set_line_style(i, styles[i])
            self.qtgui_histogram_sink_x_0_1_1_0.set_line_marker(i, markers[i])
            self.qtgui_histogram_sink_x_0_1_1_0.set_line_alpha(i, alphas[i])

        self._qtgui_histogram_sink_x_0_1_1_0_win = sip.wrapinstance(self.qtgui_histogram_sink_x_0_1_1_0.pyqwidget(), Qt.QWidget)
        self.main_tab_grid_layout_5.addWidget(self._qtgui_histogram_sink_x_0_1_1_0_win, 2, 2, 2, 2)
        for r in range(2, 4):
            self.main_tab_grid_layout_5.setRowStretch(r, 1)
        for c in range(2, 4):
            self.main_tab_grid_layout_5.setColumnStretch(c, 1)
        ...
        for c in range(2, 4):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        self.qtgui_histogram_sink_x_0_1_0_0_0 = qtgui.histogram_sink_f(
        	200,
        	360,
                -360,
                360,
        ...
        self.qtgui_histogram_sink_x_0_1_0_0_0.set_update_time(0.010)
        self.qtgui_histogram_sink_x_0_1_0_0_0.enable_autoscale(True)
        self.qtgui_histogram_sink_x_0_1_0_0_0.enable_accumulate(False)
        self.qtgui_histogram_sink_x_0_1_0_0_0.enable_grid(False)
        self.qtgui_histogram_sink_x_0_1_0_0_0.enable_axis_labels(True)

        if not True:
          self.qtgui_histogram_sink_x_0_1_0_0_0.disable_legend()
        ...
        for i in xrange(2):
            if len(labels[i]) == 0:
                self.qtgui_histogram_sink_x_0_1_0_0_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_histogram_sink_x_0_1_0_0_0.set_line_label(i, labels[i])
            self.qtgui_histogram_sink_x_0_1_0_0_0.set_line_width(i, widths[i])
            self.qtgui_histogram_sink_x_0_1_0_0_0.set_line_color(i, colors[i])
            self.qtgui_histogram_sink_x_0_1_0_0_0.set_line_style(i, styles[i])
            self.qtgui_histogram_sink_x_0_1_0_0_0.set_line_marker(i, markers[i])
            self.qtgui_histogram_sink_x_0_1_0_0_0.set_line_alpha(i, alphas[i])

        self._qtgui_histogram_sink_x_0_1_0_0_0_win = sip.wrapinstance(self.qtgui_histogram_sink_x_0_1_0_0_0.pyqwidget(), Qt.QWidget)
        self.main_tab_grid_layout_5.addWidget(self._qtgui_histogram_sink_x_0_1_0_0_0_win, 2, 0, 2, 2)
        for r in range(2, 4):
            self.main_tab_grid_layout_5.setRowStretch(r, 1)
        for c in range(0, 2):
            self.main_tab_grid_layout_5.setColumnStretch(c, 1)
        ...
        self.main_tab_grid_layout_5.addWidget(self._qtgui_freq_sink_x_1_0_win, 0, 0, 2, 2)
        for r in range(0, 2):
            self.main_tab_grid_layout_5.setRowStretch(r, 1)
        for c in range(0, 2):
            self.main_tab_grid_layout_5.setColumnStretch(c, 1)
        ...
        self.qtgui_const_sink_x_0_1.set_update_time(0.010)
        ...
        self.main_tab_grid_layout_5.addWidget(self._qtgui_const_sink_x_0_1_win, 0, 2, 2, 2)
        for r in range(0, 2):
            self.main_tab_grid_layout_5.setRowStretch(r, 1)
        for c in range(2, 4):
            self.main_tab_grid_layout_5.setColumnStretch(c, 1)
        ...
        self.main_tab_grid_layout_5.addWidget(self._phase_shift_win, 8, 0, 1, 2)
        for r in range(8, 9):
            self.main_tab_grid_layout_5.setRowStretch(r, 1)
        for c in range(0, 2):
            self.main_tab_grid_layout_5.setColumnStretch(c, 1)
        self.low_pass_filter_0_1_1 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate / decim / decim, lpf_cutoff_0, lpf_trans_0, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_1_0_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate / decim / decim, lpf_cutoff_0, lpf_trans_0, firdes.WIN_HAMMING, 6.76))
        ...
        self.blocks_multiply_const_vxx_1_0_1_0_1_0 = blocks.multiply_const_vff((180.0/math.pi, ))
        self.blocks_multiply_const_vxx_1_0_1_0_1 = blocks.multiply_const_vff((180.0/math.pi, ))
        self.blocks_multiply_const_vxx_1_0_1_0_0_0_0 = blocks.multiply_const_vff((180.0/math.pi, ))
        ...
        self.blocks_multiply_const_vxx_1_0_0 = blocks.multiply_const_vcc((complex(math.cos(phase_rad),math.sin(phase_rad)), ))
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_vcc((complex(math.cos(phase_rad),math.sin(phase_rad)), ))
        ...
        self.analog_pll_refout_cc_0_1 = analog.pll_refout_cc(math.pi/pll_lbw_0, math.pi/pll_freq_0, -math.pi/pll_freq_0)
        self.analog_pll_refout_cc_0_0_0 = analog.pll_refout_cc(math.pi/pll_lbw, math.pi/pll_freq, -math.pi/pll_freq)
        ...
        self.connect((self.analog_pll_refout_cc_0_0_0, 0), (self.blocks_multiply_conjugate_cc_1_0, 1))
        self.connect((self.analog_pll_refout_cc_0_1, 0), (self.blocks_multiply_conjugate_cc_0_0, 1))
        self.connect((self.analog_pll_refout_cc_0_1, 0), (self.blocks_multiply_conjugate_cc_1_0, 0))
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.analog_pll_refout_cc_0_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_multiply_conjugate_cc_0_0, 0))
        self.connect((self.blocks_add_xx_0_0, 0), (self.analog_pll_refout_cc_0_0_0, 0))
        ...
        self.connect((self.blocks_complex_to_arg_0_0_0, 0), (self.blocks_multiply_const_vxx_1_0_1_0_0_0_0, 0))
        self.connect((self.blocks_complex_to_arg_0_1, 0), (self.blocks_multiply_const_vxx_1_0_1_0_1_0, 0))
        ...
        self.connect((self.blocks_multiply_conjugate_cc_0_0, 0), (self.low_pass_filter_0_1_1, 0))
        self.connect((self.blocks_multiply_conjugate_cc_1, 0), (self.low_pass_filter_0_1_0, 0))
        self.connect((self.blocks_multiply_conjugate_cc_1_0, 0), (self.low_pass_filter_0_1_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0_1_0_0_0_0, 0), (self.qtgui_histogram_sink_x_0_1_0_0_0, 1))
        self.connect((self.blocks_multiply_const_vxx_1_0_1_0_0_0_0, 0), (self.qtgui_histogram_sink_x_0_1_1_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1_0_1_0_1, 0), (self.qtgui_histogram_sink_x_0_1_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1_0_1_0_1_0, 0), (self.qtgui_histogram_sink_x_0_1_0_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_multiply_conjugate_cc_0, 0))
        ...
        self.connect((self.low_pass_filter_0_1_0_0, 0), (self.blocks_complex_to_arg_0_0_0, 0))
        self.connect((self.low_pass_filter_0_1_0_0, 0), (self.qtgui_const_sink_x_0_1, 1))
        self.connect((self.low_pass_filter_0_1_0_0, 0), (self.qtgui_freq_sink_x_1_0, 1))
        self.connect((self.low_pass_filter_0_1_1, 0), (self.blocks_complex_to_arg_0_1, 0))
        self.connect((self.low_pass_filter_0_1_1, 0), (self.qtgui_const_sink_x_0_1, 0))
        self.connect((self.low_pass_filter_0_1_1, 0), (self.qtgui_freq_sink_x_1_0, 0))
    ...
    def set_phase_shift(self, phase_shift):
        ...
        self.set_phase_rad(self.phase_shift * math.pi/180.0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.rx_freq*0, self.samp_rate / self.decim / self.decim2)
        self.qtgui_freq_sink_x_0.set_frequency_range(self.rx_freq*0, self.samp_rate / self.decim / self.decim2)
        self.low_pass_filter_0_1_1.set_taps(firdes.low_pass(1, self.samp_rate / self.decim / self.decim, self.lpf_cutoff_0, self.lpf_trans_0, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_1_0_0.set_taps(firdes.low_pass(1, self.samp_rate / self.decim / self.decim, self.lpf_cutoff_0, self.lpf_trans_0, firdes.WIN_HAMMING, 6.76))
    ...
    def get_pll_lbw_0(self):
        return self.pll_lbw_0

    def set_pll_lbw_0(self, pll_lbw_0):
        self.pll_lbw_0 = pll_lbw_0
        Qt.QMetaObject.invokeMethod(self._pll_lbw_0_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.pll_lbw_0)))
        self.analog_pll_refout_cc_0_1.set_loop_bandwidth(math.pi/self.pll_lbw_0)
    ...
    def set_pll_lbw(self, pll_lbw):
        ...
        self.analog_pll_refout_cc_0_0_0.set_loop_bandwidth(math.pi/self.pll_lbw)
    ...
    def get_pll_freq_0(self):
        return self.pll_freq_0

    def set_pll_freq_0(self, pll_freq_0):
        self.pll_freq_0 = pll_freq_0
        Qt.QMetaObject.invokeMethod(self._pll_freq_0_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.pll_freq_0)))
        self.analog_pll_refout_cc_0_1.set_max_freq(math.pi/self.pll_freq_0)
        self.analog_pll_refout_cc_0_1.set_min_freq(-math.pi/self.pll_freq_0)
    ...
    def set_pll_freq(self, pll_freq):
        ...
        self.analog_pll_refout_cc_0_0_0.set_max_freq(math.pi/self.pll_freq)
        self.analog_pll_refout_cc_0_0_0.set_min_freq(-math.pi/self.pll_freq)
    ...
    def get_lpf_trans_0(self):
        return self.lpf_trans_0

    def set_lpf_trans_0(self, lpf_trans_0):
        self.lpf_trans_0 = lpf_trans_0
        Qt.QMetaObject.invokeMethod(self._lpf_trans_0_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.lpf_trans_0)))
        self.low_pass_filter_0_1_1.set_taps(firdes.low_pass(1, self.samp_rate / self.decim / self.decim, self.lpf_cutoff_0, self.lpf_trans_0, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_1_0_0.set_taps(firdes.low_pass(1, self.samp_rate / self.decim / self.decim, self.lpf_cutoff_0, self.lpf_trans_0, firdes.WIN_HAMMING, 6.76))
    ...
    def get_lpf_cutoff_0(self):
        return self.lpf_cutoff_0

    def set_lpf_cutoff_0(self, lpf_cutoff_0):
        self.lpf_cutoff_0 = lpf_cutoff_0
        Qt.QMetaObject.invokeMethod(self._lpf_cutoff_0_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.lpf_cutoff_0)))
        self.low_pass_filter_0_1_1.set_taps(firdes.low_pass(1, self.samp_rate / self.decim / self.decim, self.lpf_cutoff_0, self.lpf_trans_0, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_1_0_0.set_taps(firdes.low_pass(1, self.samp_rate / self.decim / self.decim, self.lpf_cutoff_0, self.lpf_trans_0, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=x310_dualpol_phasecorrelation_5, options=None):
