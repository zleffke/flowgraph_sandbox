...
class sigmf_rx_uhd(gr.top_block, Qt.QWidget):

    def __init__(self, addr='serial=314FC3C', note='wire format = complex int12; clock rate = 60M, samp_rate = 30M', path="/captures/20191214", signal_type='NEXRAD', usrp_type='B200'):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--path", dest="path", type="string", default="/captures/20191214",
...
def main(top_block_cls=sigmf_rx_uhd, options=None):
    if options is None:
