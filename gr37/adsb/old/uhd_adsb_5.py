...
class uhd_adsb_5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, dc_block_len=4):
        ...
        self.fosphor_glfw_sink_c_0.set_frequency_range(0, samp_rate/10)
        ...
        self.blocks_threshold_ff_0_0 = blocks.threshold_ff(0.3, 0.31, 0)
        ...
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.blocks_threshold_ff_0_0, 0))
        self.connect((self.blocks_message_source_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_threshold_ff_0_0, 0), (self.dc_blocker_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.fosphor_glfw_sink_c_0.set_frequency_range(0, self.samp_rate/10)
