...
class uhd_adsb_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._rx_offset_tool_bar, 1, 4, 1, 2)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_gain_range = Range(1, 76, 1, 12, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, rx_offset *-1, 1, 0)
    ...
    def set_rx_offset(self, rx_offset):
        ...
        self.analog_sig_source_x_0.set_frequency(self.rx_offset *-1)
