...
class radio_jove_dual_rtlsdr_sigmf_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, path="/captures/radio_jove", signal_type='RADIO-JOVE'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "radio_jove_dual_rtlsdr_sigmf_2")
        ...
        self.antenna_1 = antenna_1 = "RHCP"
        self.antenna_0 = antenna_0 = "LHCP"
        ...
        self.audio_max_gain = audio_max_gain = 100
        self.audio_lpf_cut = audio_lpf_cut = 7e3
        ...
        self._volume_range = Range(0, 200, .1, 100, 200)
        self._volume_win = RangeWidget(self._volume_range, self.set_volume, "volume", "counter_slider", float)
        self.main_tab_grid_layout_2.addWidget(self._volume_win, 7, 0, 1, 4)
        for r in range(7, 8):
        ...
        self.main_tab_grid_layout_0.addWidget(self._rx_freq_tool_bar, 5, 0, 1, 2)
        for r in range(5, 6):
        ...
        self.main_tab_grid_layout_2.addWidget(self._audio_lpf_cut_tool_bar, 9, 5, 1, 1)
        for r in range(9, 10):
            self.main_tab_grid_layout_2.setRowStretch(r, 1)
        for c in range(5, 6):
            self.main_tab_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.main_tab_grid_layout_2.addWidget(self._qtgui_waterfall_sink_x_1_win, 4, 0, 2, 8)
        for r in range(4, 6):
            self.main_tab_grid_layout_2.setRowStretch(r, 1)
        for c in range(0, 8):
            self.main_tab_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.low_pass_filter_0_1_1 = filter.fir_filter_ccf(int(audio_rate_in/audio_rate_out), firdes.low_pass(
        	1, audio_rate_in, audio_lpf_cut, 500, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_1_0_0 = filter.fir_filter_ccf(int(audio_rate_in/audio_rate_out), firdes.low_pass(
        	1, audio_rate_in, audio_lpf_cut, 500, firdes.WIN_HAMMING, 6.76))
        ...
        self.low_pass_filter_0_0_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate / decim_1*interp_1, lpf_cut, 1e3, firdes.WIN_HAMMING, 6.76))
        ...
        self.main_tab_grid_layout_2.addWidget(self._audio_max_gain_tool_bar, 9, 0, 1, 1)
        for r in range(9, 10):
            self.main_tab_grid_layout_2.setRowStretch(r, 1)
        for c in range(0, 1):
            self.main_tab_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.low_pass_filter_0_1_0, 0))
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.low_pass_filter_0_1, 0))
        ...
        self.connect((self.blocks_complex_to_mag_squared_0_0_0, 0), (self.blocks_nlog10_ff_0_0_0_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0_1, 0), (self.blocks_nlog10_ff_0_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.rational_resampler_xxx_2_0, 0))
        self.connect((self.low_pass_filter_0_0_0, 0), (self.rational_resampler_xxx_1_0, 0))
        self.connect((self.low_pass_filter_0_1, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.low_pass_filter_0_1, 0), (self.blocks_complex_to_real_0_0, 0))
        self.connect((self.low_pass_filter_0_1_0, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
        self.connect((self.low_pass_filter_0_1_0, 0), (self.blocks_complex_to_real_0_0_0, 0))
        self.connect((self.low_pass_filter_0_1_0_0, 0), (self.blocks_complex_to_mag_squared_0_1, 0))
        self.connect((self.low_pass_filter_0_1_1, 0), (self.blocks_complex_to_mag_squared_0_0_0, 0))
        self.connect((self.osmosdr_source_0, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.osmosdr_source_0_0, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.rational_resampler_xxx_1, 0), (self.low_pass_filter_0_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.blocks_add_xx_0_0, 0))
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.low_pass_filter_0_1_1, 0))
        ...
        self.connect((self.rational_resampler_xxx_2_0, 0), (self.blocks_multiply_const_vxx_1_0_0_0, 0))
        self.connect((self.rational_resampler_xxx_2_0, 0), (self.blocks_multiply_const_vxx_1_0_1, 0))
        self.connect((self.rational_resampler_xxx_2_0, 0), (self.low_pass_filter_0_1_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0_1_0.set_frequency_range(0, self.samp_rate/(self.decim_1*self.decim_2) *(self.interp_1*self.interp_2))
        ...
        self.qtgui_waterfall_sink_x_0_0_0_0.set_frequency_range(0, self.samp_rate/(self.decim_1*self.decim_2) *(self.interp_1*self.interp_2))
        ...
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(0, self.samp_rate / self.decim_1 *self.interp_1)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.samp_rate / self.decim_1 *self.interp_1)
        self.qtgui_freq_sink_x_0.set_frequency_range(self.rx_freq, self.samp_rate / self.decim_1 *self.interp_1)
        self.osmosdr_source_0_0.set_sample_rate(self.samp_rate)
        self.osmosdr_source_0.set_sample_rate(self.samp_rate)
        self.low_pass_filter_0_0_0.set_taps(firdes.low_pass(1, self.samp_rate / self.decim_1*self.interp_1, self.lpf_cut, 1e3, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate / self.decim_1*self.interp_1, self.lpf_cut, 1e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_audio_rate_in(self, audio_rate_in):
        ...
        self.low_pass_filter_0_1_1.set_taps(firdes.low_pass(1, self.audio_rate_in, self.audio_lpf_cut, 500, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_1_0_0.set_taps(firdes.low_pass(1, self.audio_rate_in, self.audio_lpf_cut, 500, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=radio_jove_dual_rtlsdr_sigmf_2, options=None):
    if options is None:
