...
class sar_record_sigmf(gr.top_block, Qt.QWidget):

    def __init__(self, addr='serial=313E33A', note='wire format = complex int12; clock rate = 60M, samp_rate = 15M', path="/captures/20191228", signal_type='NEXRAD', usrp_type='B205'):
        gr.top_block.__init__(self, "sar_record_sigmf")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("sar_record_sigmf")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sar_record_sigmf")
...
def argument_parser():
    ...
    parser.add_option(
        "", "--addr", dest="addr", type="string", default='serial=313E33A',
    ...
    parser.add_option(
        "", "--usrp-type", dest="usrp_type", type="string", default='B205',
        help="Set usrp_type [default=%default]")
    return parser


def main(top_block_cls=sar_record_sigmf, options=None):
    if options is None:
