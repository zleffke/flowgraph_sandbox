...
# Generated: Wed Jul 11 11:34:35 2018
##################################################
...
class radiosonde_rx_usrp(gr.top_block, Qt.QWidget):

    def __init__(self, radio_id='USRP', sat_name='FOX-1D'):
        gr.top_block.__init__(self, "LMS6 Radiosonde Receiver, USRP")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LMS6 Radiosonde Receiver, USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "radiosonde_rx_usrp")
        ...
        self.rx_freq = rx_freq = 145.880e6
...
def main(top_block_cls=radiosonde_rx_usrp, options=None):
    if options is None:
