...
# Title: Kiss Ax25 Hdlc Scramble Ref
# Author: Zach Leffke, KJ4QLP
# Description: Reference for KISS, AX.25, HDLC Framer, Scrambler
#
# Generated: Sun Sep  8 23:17:31 2019
...
class kiss_ax25_hdlc_scramble_ref(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Kiss Ax25 Hdlc Scramble Ref")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Kiss Ax25 Hdlc Scramble Ref")
        ...
        self.settings = Qt.QSettings("GNU Radio", "kiss_ax25_hdlc_scramble_ref")
...
def main(top_block_cls=kiss_ax25_hdlc_scramble_ref, options=None):
