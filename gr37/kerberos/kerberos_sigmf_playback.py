...
class kerberos_sigmf_playback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sigmf_source_3 = gr_sigmf.source('/home/zleffke/captures/kerberos/20210326/no_noise/CHAN3_2021-03-26T21:04:01Z.sigmf-data', "cf32" + ("_le" if sys.byteorder == "little" else "_be"), False)
        self.sigmf_source_2 = gr_sigmf.source('/home/zleffke/captures/kerberos/20210326/no_noise/CHAN2_2021-03-26T21:04:01Z.sigmf-data', "cf32" + ("_le" if sys.byteorder == "little" else "_be"), False)
        self.sigmf_source_1 = gr_sigmf.source('/home/zleffke/captures/kerberos/20210326/no_noise/CHAN1_2021-03-26T21:04:01Z.sigmf-data', "cf32" + ("_le" if sys.byteorder == "little" else "_be"), False)
        self.sigmf_source_0 = gr_sigmf.source('/home/zleffke/captures/kerberos/20210326/no_noise/CHAN0_2021-03-26T21:04:01Z.sigmf-data', "cf32" + ("_le" if sys.byteorder == "little" else "_be"), False)
        ...
        self.connect((self.analog_agc2_xx_0_0, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0_0, 0), (self.qtgui_time_sink_x_0, 1))
        ...
        self.connect((self.blocks_throttle_2, 0), (self.qtgui_freq_sink_x_0, 2))
        self.connect((self.blocks_throttle_3, 0), (self.qtgui_freq_sink_x_0, 3))
...
def main(top_block_cls=kerberos_sigmf_playback, options=None):
