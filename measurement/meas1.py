...
class meas1(gr.top_block, Qt.QWidget):

    def __init__(self, avg_len=256, nfft=2048):
        gr.top_block.__init__(self, "Meas1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Meas1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "meas1")
...
def main(top_block_cls=meas1, options=None):
    if options is None:
