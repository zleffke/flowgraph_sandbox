...
# Generated: Tue Dec  5 03:24:21 2017
##################################################
...
class orbcomm_beacon_rx_exp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._qtgui_waterfall_sink_x_0_win, 0,6,3,6)
        ...
        labels = ['Freq', 'Sig_Ampl', 'Noise_Ampl', 'SNR', '',
                  '', '', '', '', '']
        units = ['Hz', 'dB', 'dB', 'dB', '',
                 '', '', '', '', '']
        ...
        self.top_grid_layout.addWidget(self._qtgui_histogram_sink_x_0_win, 3,6,3,6)
        ...
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_float*1, 4096)
        ...
        self.blocks_nlog10_ff_0 = blocks.nlog10_ff(10, fft_size, -20*math.log10(fft_size))
        ...
        self.connect((self.blocks_add_const_vxx_0, 0), (self.qtgui_number_sink_0_0_0, 0))
        ...
        self.connect((self.blocks_keep_one_in_n_0, 0), (self.qtgui_number_sink_0_0_0, 2))
        self.connect((self.blocks_max_xx_0, 0), (self.blocks_sub_xx_0, 0))
        self.connect((self.blocks_max_xx_0, 0), (self.qtgui_number_sink_0_0_0, 1))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.qtgui_number_sink_0_0_0, 3))
        ...
        self.connect((self.single_pole_iir_filter_xx_0, 0), (self.qtgui_histogram_sink_x_0, 0))
...
def main(top_block_cls=orbcomm_beacon_rx_exp, options=None):
