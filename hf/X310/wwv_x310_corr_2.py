...
# Title: X310 Phase Calibration, Start Time [UTC]: 2020-09-08T03:27:05.273477Z
...
class wwv_x310_corr_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "X310 Phase Calibration, Start Time [UTC]: 2020-09-08T03:27:05.273477Z")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("X310 Phase Calibration, Start Time [UTC]: 2020-09-08T03:27:05.273477Z")
        ...
        self.settings = Qt.QSettings("GNU Radio", "wwv_x310_corr_2")
...
def main(top_block_cls=wwv_x310_corr_2, options=None):
