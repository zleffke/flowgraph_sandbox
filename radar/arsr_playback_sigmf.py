...
class arsr_playback_sigmf(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Arsr Playback Sigmf")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Arsr Playback Sigmf")
        ...
        self.settings = Qt.QSettings("GNU Radio", "arsr_playback_sigmf")
        ...
        # Variables
        ##################################################
        self.tune = tune = 2.5e6
        self.trig_lvl = trig_lvl = 50
        ...
        for c in range(6, 7):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.single_pole_iir_filter_xx_0_0 = filter.single_pole_iir_filter_ff(alpha_0, 1)
        self.single_pole_iir_filter_xx_0 = filter.single_pole_iir_filter_ff(alpha_0, 1)
        self.sigmf_source_0 = gr_sigmf.source('/captures/20191215/ASR_2019-12-15T19:35:49Z.sigmf-data', "ci16" + ("_le" if sys.byteorder == "little" else "_be"), True)
        ...
        self.connect((self.analog_agc2_xx_0, 0), (self.blocks_multiply_xx_0_0, 0))
        ...
        self.connect((self.single_pole_iir_filter_xx_0_0, 0), (self.qtgui_time_sink_x_0, 1))
    ...
    def set_alpha_0(self, alpha_0):
        ...
        self.single_pole_iir_filter_xx_0_0.set_taps(self.alpha_0)
        self.single_pole_iir_filter_xx_0.set_taps(self.alpha_0)


def main(top_block_cls=arsr_playback_sigmf, options=None):
