...
class codar_playback_sigmf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(4, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.sigmf_source_0 = gr_sigmf.source('/captures/20210404/CODAR_2021-05-05T04:51:43Z.sigmf-data', "cf32" + ("_le" if sys.byteorder == "little" else "_be"), True)
...
def main(top_block_cls=codar_playback_sigmf, options=None):
