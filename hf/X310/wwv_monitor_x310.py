...
# Title: WWV Monitor X310, Start Time [UTC]: 2020-08-04T04:08:26.091451Z
...
class wwv_monitor_x310(gr.top_block, Qt.QWidget):

    def __init__(self, avg_len=1, nfft=2048*4):
        gr.top_block.__init__(self, "WWV Monitor X310, Start Time [UTC]: 2020-08-04T04:08:26.091451Z")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("WWV Monitor X310, Start Time [UTC]: 2020-08-04T04:08:26.091451Z")
        ...
        self.settings = Qt.QSettings("GNU Radio", "wwv_monitor_x310")
        ...
        self.connect((self.blocks_add_const_vxx_0, 0), (self.qtgui_number_sink_0, 1))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--nfft", dest="nfft", type="intx", default=2048*4,
        help="Set nfft [default=%default]")
    return parser


def main(top_block_cls=wwv_monitor_x310, options=None):
    if options is None:
