...
# Title: WWV Monitor X310, Start Time [UTC]: 2020-09-08T04:00:55.012868Z
...
class WWV_monitor_X310_fft_2chan(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, avg_len=1, nfft=2048*8):
        gr.top_block.__init__(self, "WWV Monitor X310, Start Time [UTC]: 2020-09-08T04:00:55.012868Z")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("WWV Monitor X310, Start Time [UTC]: 2020-09-08T04:00:55.012868Z")
        ...
        for _label in self._decay_rate_labels: self._decay_rate_combo_box.addItem(_label)
        ...
        for _label in self._wwv_freq_labels: self._wwv_freq_combo_box.addItem(_label)
        ...
        self._coarse_tune_line_edit.returnPressed.connect(
            lambda: self.set_coarse_tune(eng_notation.str_to_num(str(self._coarse_tune_line_edit.text()))))
        ...
        self.blocks_multiply_const_vxx_0_0_1 = blocks.multiply_const_ff(hz_per_bin)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(hz_per_bin)
        ...
        self.blocks_add_const_vxx_0_0 = blocks.add_const_ff(-samp_rate/decim/decim_2/2)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(-samp_rate/decim/decim_2/2)
...
def argument_parser():
    ...
    parser.add_argument(
        "--avg-len", dest="avg_len", type=eng_float, default="1.0",
