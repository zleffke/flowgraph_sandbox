...
# Title: 2020-08-13T03:19:25.017847Z
...
class n210_record_short(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "2020-08-13T03:19:25.017847Z")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("2020-08-13T03:19:25.017847Z")
        ...
        self.settings = Qt.QSettings("GNU Radio", "n210_record_short")
        ...
        self.path = path = "/tmp"
        self.fn = fn = "{:s}_{:s}.ci16".format(signal_type, ts_str)
        ...
        self.uhd_usrp_source_0.set_clock_rate(100e6, uhd.ALL_MBOARDS)
    ...
    def set_ts_str(self, ts_str):
        self.ts_str = ts_str
        self.set_fn("{:s}_{:s}.ci16".format(self.signal_type, self.ts_str))
...
def main(top_block_cls=n210_record_short, options=None):
