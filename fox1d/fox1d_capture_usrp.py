...
class fox1d_capture_usrp(gr.top_block, Qt.QWidget):

    def __init__(self, radio_id='USRP', sat_name='FOX-1D'):
        gr.top_block.__init__(self, "USRP Based Fox-1D capture flowgraph")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("USRP Based Fox-1D capture flowgraph")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fox1d_capture_usrp")
...
def main(top_block_cls=fox1d_capture_usrp, options=None):
    if options is None:
