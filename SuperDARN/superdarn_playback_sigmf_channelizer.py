...
# Title: superdarn_playback_sigmf
# Author: Zach Leffke
...
class superdarn_playback_sigmf_channelizer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "superdarn_playback_sigmf_channelizer")
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_0_win, 0, 4, 2, 4)
        for r in range(0, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.pfb_channelizer_ccf_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.pfb_channelizer_ccf_0, 1), (self.qtgui_freq_sink_x_0_0_0, 1))
        self.connect((self.pfb_channelizer_ccf_0, 2), (self.qtgui_freq_sink_x_0_0_0, 2))
        self.connect((self.pfb_channelizer_ccf_0, 3), (self.qtgui_freq_sink_x_0_0_0, 3))
        self.connect((self.pfb_channelizer_ccf_0, 4), (self.qtgui_freq_sink_x_0_0_0, 4))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(0, self.samp_rate/self.decim/5)
...
def main(top_block_cls=superdarn_playback_sigmf_channelizer, options=None):
