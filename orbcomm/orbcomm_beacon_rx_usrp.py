...
# Generated: Sat Dec  2 21:33:45 2017
##################################################
...
class orbcomm_beacon_rx_usrp(gr.top_block, Qt.QWidget):

    def __init__(self, radio_id='USRP', sat_name='FMXX'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "orbcomm_beacon_rx_usrp")
        ...
        self.decim = decim = 5
        self.fn = fn = "ORBCOMM_{:s}_{:s}_{:s}_{:s}k.fc32".format(sat_name, radio_id, ts_str, str(int(samp_rate/decim)/1000))
        ...
        self.fp = fp = "/home/zleffke/captures/orbcomm/{:s}".format(fn)
    ...
    def set_fn(self, fn):
        self.fn = fn
        self.set_fp("/home/zleffke/captures/orbcomm/{:s}".format(self.fn))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--sat-name", dest="sat_name", type="string", default='FMXX',
        help="Set sat_name [default=%default]")
    return parser


def main(top_block_cls=orbcomm_beacon_rx_usrp, options=None):
    if options is None:
