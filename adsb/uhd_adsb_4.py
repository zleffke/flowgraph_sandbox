...
# Title: Uhd Adsb 4
# Generated: Tue Dec 13 17:49:21 2016
##################################################
...
class uhd_adsb_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, .00001, .00005, 0, "")
...
def main(top_block_cls=uhd_adsb_4, options=None):
