...
# Title: Dual Polarization Phase Correlation, Start Time [UTC]: 2020-09-11T04:53:25.717631Z
...
class x310_dualpol_phasecorrelation_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Dual Polarization Phase Correlation, Start Time [UTC]: 2020-09-11T04:53:25.717631Z")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dual Polarization Phase Correlation, Start Time [UTC]: 2020-09-11T04:53:25.717631Z")
        ...
        self.settings = Qt.QSettings("GNU Radio", "x310_dualpol_phasecorrelation_2")
        ...
        self.connect((self.blocks_abs_xx_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 2))
        ...
        self.connect((self.blocks_complex_to_magphase_1, 1), (self.blocks_multiply_const_vxx_1_0_1_0_0, 0))
        self.connect((self.blocks_complex_to_magphase_1, 0), (self.blocks_sub_xx_0, 1))
        self.connect((self.blocks_complex_to_magphase_1, 0), (self.qtgui_time_sink_x_0_0, 1))
...
def main(top_block_cls=x310_dualpol_phasecorrelation_2, options=None):
