...
# Title: Kerberos Sigmf Phasealign
...
class kerberos_sigmf_PhaseAlign(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Kerberos Sigmf Phasealign")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Kerberos Sigmf Phasealign")
        ...
        self.settings = Qt.QSettings("GNU Radio", "kerberos_sigmf_PhaseAlign")
        ...
        # Variables
        ##################################################
        self.phase_offset_0_3 = phase_offset_0_3 = 0
        self.phase_offset_0_2 = phase_offset_0_2 = 0
        self.phase_offset_0_1 = phase_offset_0_1 = 0
        ...
        self.phase_rad = phase_rad = math.pi/180.0
        self.note_phase_offset_0_3 = note_phase_offset_0_3 = phase_offset_0_3
        self.note_phase_offset_0_2 = note_phase_offset_0_2 = phase_offset_0_2
        self.note_phase_offset_0_1 = note_phase_offset_0_1 = phase_offset_0_1
        self.nfft = nfft = 8192
        ...
        # Blocks
        ##################################################
        self.probe_phase_delta_0_3 = blocks.probe_signal_f()
        self.probe_phase_delta_0_2 = blocks.probe_signal_f()
        self.probe_phase_delta_0_1 = blocks.probe_signal_f()
        ...
        self.main_tab.addTab(self.main_tab_widget_3, 'Phase Analysis')
        ...
        self.main_tab_grid_layout_3.addWidget(self._thresh_phase_tool_bar, 6, 0, 1, 1)
        for r in range(6, 7):
        ...
        def _phase_offset_0_3_probe():
            while True:
                val = self.probe_phase_delta_0_3.level()
                try:
                    self.set_phase_offset_0_3(val)
                except AttributeError:
                    pass
                time.sleep(1.0 / (100))
        _phase_offset_0_3_thread = threading.Thread(target=_phase_offset_0_3_probe)
        _phase_offset_0_3_thread.daemon = True
        _phase_offset_0_3_thread.start()


        def _phase_offset_0_2_probe():
            while True:
                val = self.probe_phase_delta_0_2.level()
                try:
                    self.set_phase_offset_0_2(val)
                except AttributeError:
                    pass
                time.sleep(1.0 / (100))
        _phase_offset_0_2_thread = threading.Thread(target=_phase_offset_0_2_probe)
        _phase_offset_0_2_thread.daemon = True
        _phase_offset_0_2_thread.start()


        def _phase_offset_0_1_probe():
            while True:
                val = self.probe_phase_delta_0_1.level()
                try:
                    self.set_phase_offset_0_1(val)
                except AttributeError:
                    pass
                time.sleep(1.0 / (100))
        _phase_offset_0_1_thread = threading.Thread(target=_phase_offset_0_1_probe)
        _phase_offset_0_1_thread.daemon = True
        _phase_offset_0_1_thread.start()
        ...
        self.main_tab_grid_layout_3.addWidget(self._qtgui_time_sink_x_2_win, 2, 0, 2, 4)
        for r in range(2, 4):
            self.main_tab_grid_layout_3.setRowStretch(r, 1)
        for c in range(0, 4):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        ...
        self.qtgui_time_sink_x_0_1_1_1_0 = qtgui.time_sink_f(
        	512, #size
        	samp_rate, #samp_rate
        	"Absolute Aligned", #name
        	5 #number of inputs
        )
        self.qtgui_time_sink_x_0_1_1_1_0.set_update_time(0.010)
        self.qtgui_time_sink_x_0_1_1_1_0.set_y_axis(-1, 1)

        self.qtgui_time_sink_x_0_1_1_1_0.set_y_label('Phase', "deg")

        self.qtgui_time_sink_x_0_1_1_1_0.enable_tags(-1, True)
        self.qtgui_time_sink_x_0_1_1_1_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, thresh_phase, 0.00005, 4, "")
        ...
        if not True:
          self.qtgui_time_sink_x_0_1_1_1_0.disable_legend()
        ...
        self._qtgui_time_sink_x_0_1_1_1_0_win = sip.wrapinstance(self.qtgui_time_sink_x_0_1_1_1_0.pyqwidget(), Qt.QWidget)
        self.main_tab_grid_layout_3.addWidget(self._qtgui_time_sink_x_0_1_1_1_0_win, 4, 0, 2, 4)
        for r in range(4, 6):
            self.main_tab_grid_layout_3.setRowStretch(r, 1)
        for c in range(0, 4):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        ...
        self.main_tab_grid_layout_3.addWidget(self._qtgui_time_sink_x_0_1_1_1_win, 0, 0, 2, 4)
        for r in range(0, 2):
            self.main_tab_grid_layout_3.setRowStretch(r, 1)
        for c in range(0, 4):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        ...
        for c in range(0, 1):
            self.main_tab_grid_layout_0.setColumnStretch(c, 1)
        self._note_phase_offset_0_3_tool_bar = Qt.QToolBar(self)

        if None:
          self._note_phase_offset_0_3_formatter = None
        else:
          self._note_phase_offset_0_3_formatter = lambda x: eng_notation.num_to_str(x)

        self._note_phase_offset_0_3_tool_bar.addWidget(Qt.QLabel('Phase Offset 0to3'+": "))
        self._note_phase_offset_0_3_label = Qt.QLabel(str(self._note_phase_offset_0_3_formatter(self.note_phase_offset_0_3)))
        self._note_phase_offset_0_3_tool_bar.addWidget(self._note_phase_offset_0_3_label)
        self.main_tab_grid_layout_3.addWidget(self._note_phase_offset_0_3_tool_bar, 6, 3, 1, 1)
        for r in range(6, 7):
            self.main_tab_grid_layout_3.setRowStretch(r, 1)
        for c in range(3, 4):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        self._note_phase_offset_0_2_tool_bar = Qt.QToolBar(self)

        if None:
          self._note_phase_offset_0_2_formatter = None
        else:
          self._note_phase_offset_0_2_formatter = lambda x: eng_notation.num_to_str(x)

        self._note_phase_offset_0_2_tool_bar.addWidget(Qt.QLabel('Phase Offset 0to2'+": "))
        self._note_phase_offset_0_2_label = Qt.QLabel(str(self._note_phase_offset_0_2_formatter(self.note_phase_offset_0_2)))
        self._note_phase_offset_0_2_tool_bar.addWidget(self._note_phase_offset_0_2_label)
        self.main_tab_grid_layout_3.addWidget(self._note_phase_offset_0_2_tool_bar, 6, 2, 1, 1)
        for r in range(6, 7):
            self.main_tab_grid_layout_3.setRowStretch(r, 1)
        for c in range(2, 3):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        self._note_phase_offset_0_1_tool_bar = Qt.QToolBar(self)

        if None:
          self._note_phase_offset_0_1_formatter = None
        else:
          self._note_phase_offset_0_1_formatter = lambda x: eng_notation.num_to_str(x)

        self._note_phase_offset_0_1_tool_bar.addWidget(Qt.QLabel('Phase Offset 0to1'+": "))
        self._note_phase_offset_0_1_label = Qt.QLabel(str(self._note_phase_offset_0_1_formatter(self.note_phase_offset_0_1)))
        self._note_phase_offset_0_1_tool_bar.addWidget(self._note_phase_offset_0_1_label)
        self.main_tab_grid_layout_3.addWidget(self._note_phase_offset_0_1_tool_bar, 6, 1, 1, 1)
        for r in range(6, 7):
            self.main_tab_grid_layout_3.setRowStretch(r, 1)
        for c in range(1, 2):
            self.main_tab_grid_layout_3.setColumnStretch(c, 1)
        ...
        self.blocks_multiply_const_vxx_1_0_2 = blocks.multiply_const_vcc((complex(math.cos(0),math.sin(0)), ))
        self.blocks_multiply_const_vxx_1_0_1_0_1 = blocks.multiply_const_vff((180.0/math.pi, ))
        self.blocks_multiply_const_vxx_1_0_1_0_0_2 = blocks.multiply_const_vff((180.0/math.pi, ))
        self.blocks_multiply_const_vxx_1_0_1_0_0_1_0 = blocks.multiply_const_vff((180.0/math.pi, ))
        ...
        self.blocks_multiply_const_vxx_1_0_1 = blocks.multiply_const_vcc((complex(math.cos(-1*phase_offset_0_3*phase_rad),math.sin(-1*phase_offset_0_3*phase_rad)), ))
        self.blocks_multiply_const_vxx_1_0_0 = blocks.multiply_const_vcc((complex(math.cos(-1*phase_offset_0_2*phase_rad),math.sin(-1*phase_offset_0_2*phase_rad)), ))
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_vcc((complex(math.cos(-1*phase_offset_0_1*phase_rad),math.sin(-1*phase_offset_0_1*phase_rad)), ))
        ...
        self.blocks_complex_to_arg_0_0_2 = blocks.complex_to_arg(1)
        self.blocks_complex_to_arg_0_0_1_0 = blocks.complex_to_arg(1)
        ...
        self.connect((self.blocks_complex_to_arg_0_0_0_0, 0), (self.blocks_multiply_const_vxx_1_0_1_0_0_0_0, 0))
        self.connect((self.blocks_complex_to_arg_0_0_1, 0), (self.blocks_multiply_const_vxx_1_0_1_0_0_1, 0))
        self.connect((self.blocks_complex_to_arg_0_0_1_0, 0), (self.blocks_multiply_const_vxx_1_0_1_0_0_1_0, 0))
        self.connect((self.blocks_complex_to_arg_0_0_2, 0), (self.blocks_multiply_const_vxx_1_0_1_0_0_2, 0))
        self.connect((self.blocks_complex_to_arg_0_1, 0), (self.blocks_multiply_const_vxx_1_0_1_0_1, 0))
        ...
        self.connect((self.blocks_complex_to_mag_squared_1_0_0_0_0_2, 0), (self.qtgui_time_sink_x_0_1_1_1_0, 4))
        ...
        self.connect((self.blocks_delay_0_0, 0), (self.blocks_multiply_const_vxx_1_0_2, 0))
        ...
        self.connect((self.blocks_delay_2_0, 0), (self.blocks_multiply_const_vxx_1_0_0, 0))
        ...
        self.connect((self.blocks_delay_3_0, 0), (self.blocks_multiply_const_vxx_1_0_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.blocks_complex_to_arg_0_0_2, 0))
        self.connect((self.blocks_multiply_const_vxx_1_0_0, 0), (self.blocks_complex_to_arg_0_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1_0_1, 0), (self.blocks_complex_to_arg_0_0_1_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0_1_0_0_0_0, 0), (self.qtgui_time_sink_x_0_1_1_1_0, 2))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0_1_0_0_1_0, 0), (self.qtgui_time_sink_x_0_1_1_1_0, 3))
        self.connect((self.blocks_multiply_const_vxx_1_0_1_0_0_2, 0), (self.qtgui_time_sink_x_0_1_1_1_0, 1))
        self.connect((self.blocks_multiply_const_vxx_1_0_1_0_1, 0), (self.qtgui_time_sink_x_0_1_1_1_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1_0_2, 0), (self.blocks_complex_to_arg_0_1, 0))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.probe_phase_delta_0_1, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.blocks_sub_xx_0_0, 0), (self.probe_phase_delta_0_2, 0))
        self.connect((self.blocks_sub_xx_0_0, 0), (self.qtgui_time_sink_x_2, 1))
        self.connect((self.blocks_sub_xx_0_0_0, 0), (self.probe_phase_delta_0_3, 0))
    ...
    def get_phase_offset_0_3(self):
        return self.phase_offset_0_3

    def set_phase_offset_0_3(self, phase_offset_0_3):
        self.phase_offset_0_3 = phase_offset_0_3
        self.set_note_phase_offset_0_3(self._note_phase_offset_0_3_formatter(self.phase_offset_0_3))
        self.blocks_multiply_const_vxx_1_0_1.set_k((complex(math.cos(-1*self.phase_offset_0_3*self.phase_rad),math.sin(-1*self.phase_offset_0_3*self.phase_rad)), ))

    def get_phase_offset_0_2(self):
        return self.phase_offset_0_2

    def set_phase_offset_0_2(self, phase_offset_0_2):
        self.phase_offset_0_2 = phase_offset_0_2
        self.set_note_phase_offset_0_2(self._note_phase_offset_0_2_formatter(self.phase_offset_0_2))
        self.blocks_multiply_const_vxx_1_0_0.set_k((complex(math.cos(-1*self.phase_offset_0_2*self.phase_rad),math.sin(-1*self.phase_offset_0_2*self.phase_rad)), ))

    def get_phase_offset_0_1(self):
        return self.phase_offset_0_1

    def set_phase_offset_0_1(self, phase_offset_0_1):
        self.phase_offset_0_1 = phase_offset_0_1
        self.set_note_phase_offset_0_1(self._note_phase_offset_0_1_formatter(self.phase_offset_0_1))
        self.blocks_multiply_const_vxx_1_0.set_k((complex(math.cos(-1*self.phase_offset_0_1*self.phase_rad),math.sin(-1*self.phase_offset_0_1*self.phase_rad)), ))
    ...
    def set_thresh_phase(self, thresh_phase):
        ...
        self.qtgui_time_sink_x_0_1_1_1_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, self.thresh_phase, 0.00005, 4, "")
    ...
    def get_note_phase_offset_0_3(self):
        return self.note_phase_offset_0_3

    def set_note_phase_offset_0_3(self, note_phase_offset_0_3):
        self.note_phase_offset_0_3 = note_phase_offset_0_3
        Qt.QMetaObject.invokeMethod(self._note_phase_offset_0_3_label, "setText", Qt.Q_ARG("QString", self.note_phase_offset_0_3))

    def get_note_phase_offset_0_2(self):
        return self.note_phase_offset_0_2

    def set_note_phase_offset_0_2(self, note_phase_offset_0_2):
        self.note_phase_offset_0_2 = note_phase_offset_0_2
        Qt.QMetaObject.invokeMethod(self._note_phase_offset_0_2_label, "setText", Qt.Q_ARG("QString", self.note_phase_offset_0_2))

    def get_note_phase_offset_0_1(self):
        return self.note_phase_offset_0_1

    def set_note_phase_offset_0_1(self, note_phase_offset_0_1):
        self.note_phase_offset_0_1 = note_phase_offset_0_1
        Qt.QMetaObject.invokeMethod(self._note_phase_offset_0_1_label, "setText", Qt.Q_ARG("QString", self.note_phase_offset_0_1))
...
def main(top_block_cls=kerberos_sigmf_PhaseAlign, options=None):
